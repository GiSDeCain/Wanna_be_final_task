...
class Backend:
    ...
    def add_new_product(self):
        wd = self.app.wd
        wd.find_element_by_xpath('//*[@id="main"]/ul/li[3]/a').click()

    def fill_new_product(self):
        wd = self.app.wd
        wd.find_element_by_name("name[en]").clear()
        wd.find_element_by_name("name[en]").send_keys(Config.product_name01)
        wd.find_element_by_xpath('//*[@id="tab-general"]/div/div[1]/div[1]/div/div/label[1]').click()
        wd.find_element_by_link_text("Prices").click()
        wd.find_element_by_name("prices[USD]").clear()
        wd.find_element_by_name("prices[USD]").send_keys(Config.product_price)
